inputstr = 1
local orig_key_press = ChatGui.key_press
...
Hooks:PreHook(ChatGui, "update_key_down", "cg_update_key_down_cn_backspace", function(self, o, k, ...)
    local match = false
    for i = 97, 122 do 
...
Hooks:PreHook(ChatGui, "enter_text", "cg_enter_text_cn_backspace", function(self, o, s, ...)
...
Hooks:PostHook(ChatGui, "enter_text", "cg_enter_text_cn_insert", function(self, o, s, ...)
...
Hooks:PreHook(ChatGui, "key_release", "cg_key_release_cn_backspace", function(self, o, k, ...)
    inputstr = 0
end) 
